#!/usr/bin/env python3
"""Validation script for machine-learning skill.
Category: general
"""
...
def validate_config(config_path: str) -> dict:
    ...
    return {"valid": len(errors) == 0, "errors": errors, "config": config if not errors else None}
...
def validate_skill_structure(skill_path: str) -> dict:
    ...
    return {"valid": len(errors) == 0, "errors": errors, "skill_name": os.path.basename(skill_path)}
